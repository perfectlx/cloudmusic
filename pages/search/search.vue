<template>
	<view class="search">
		<musichead title="搜索" :icon="true" :iconBlack="true" style="font-size: 36rpx;"></musichead>
					...
					<view class="search-result">
						...
						<view class="search-result-item" v-for="(item,index) in searchList" :key="index" @tap="handleToDetail(item.id)">
							<view class="search-result-word">
								...
								<view>
								<image class="search-result-img1" src="../../static/dujia.png"></image>
...
<style scoped>
	...
	.search-hot-item{ display: flex; align-items: center; margin-top: 50rpx;}
	.search-hot-top{ width:60rpx; color:#fb2222; font-size:34rpx;}
	...
	.search-result-word view:nth-child(2){ font-size:26rpx;color: #898989;}
	...
	.search-result-img1{width:30rpx;height: 20rpx;margin-bottom: 2rpx;margin-right: 5rpx;}
</style>
